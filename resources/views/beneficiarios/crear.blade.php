                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="afiliado_id" id="afiliado_id"  value="{{ $afiliado->id }}" class="form-control" >
                                ...
                                <div class="col-sm">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" name="parentesco" id="parentesco">
                                            ...
                                            <option value="Esposo" {{ old('parentesco') == "Esposo" ? 'selected' : '' }}>Esposo</option>
                                            ...
                                            <option value="Hija" {{ old('parentesco') == "Hija" ? 'selected' : '' }}>Hijo</option>
                                            <option value="Hijo" {{ old('parentesco') == "Hijo" ? 'selected' : '' }}>Hija</option>
                                          </select>
                                    </div>
                                </div>
                            </div>
